...
const GridView = ({ video }) => {
    return (
        <div className="sm:hidden flex flex-col">
            {/* video thumbnail */}
            <div>
                <Image src={video.thumbnailUrl} className='rounded-md hover:rounded-none ease-in duration-300 w-full' alt='{video.title}' width={100} height={100} />
            </div>
                ...
                <div className='w-full'>
                    ...
                    <div>
                        ...
                        <div className="flex text-xs text-gray-400">
                            <p>{video.meta && video.meta.views} views • {video.createdAt}</p>
                        </div>
                    </div>
                </div>
            </div>
